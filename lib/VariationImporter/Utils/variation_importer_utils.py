...
template_dir = "/kb/module/lib/VariationImporter/Utils/report_template.html"
...
class variation_importer_utils:
    ...
    def _validate_vcf(self, vcf_filepath, vcf_version):
        ...
        p = subprocess.Popen(validator_cmd,
                             ...
                             shell=False)
        validator_output, validator_error = p.communicate()
        # validator_output = []
        # while True:
    ...
    def _generate_report(self, params, variation_results,
        ...
        stats_results = self._generate_variation_stats(params['additional_output_type'],
                                                       variation_file_path)
        ...
        try:
            ...
            with open(template_dir, 'r') as html, open(variation_results['validation_output_filepath'], 'r') as validation:
                ...
                if variation_results.get('valid_variation_file'):
                    validation_content += '<em>is a valid </em> variation file.'
                else:
            ...
            log("Error generating HTML report.")
            raise
    ...
    def _generate_variation_stats(self, additional_output_type, variation_filepath):
        """
